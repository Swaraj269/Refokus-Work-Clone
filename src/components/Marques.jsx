...
function Marques() {
  ...
  return (
    <div className='flex flex-col overflow-hidden items-center gap-8 py-32 mt-8'>
        {images.map((elem,index) => <Marque key={index} direction ={index===0 ?'left':'right'} images = {elem} />)}
    </div>
  )
}
